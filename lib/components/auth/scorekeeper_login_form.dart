...
class ScorekeeperLoginForm extends StatefulWidget {
  final Function toggleAuth;
  const ScorekeeperLoginForm({super.key, required this.toggleAuth});

  @override
  State<ScorekeeperLoginForm> createState() => _ScorekeeperLoginFormState();
}

class _ScorekeeperLoginFormState extends State<ScorekeeperLoginForm> {
  ...
  Future<void> _handleLogin() async {
    if (_formKey.currentState!.validate()) {
      ...
      List<String?> result =
          await _authService.loginScorekeeper(email, password);
