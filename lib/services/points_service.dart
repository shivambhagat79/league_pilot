...
Future<void> updateCricketPointsTable({
  ...
  Stream<Map<String, List<Map<String, dynamic>>>> streamAllSportsTables(String tournamentId) {
    ...
    for (final doc in snapshot.docs) {
      ...
      standingsMap.forEach((contingentName, statsAny) {
        if (statsAny is Map) {
          ...
          Map<String, dynamic> contingentData = Map<String, dynamic>.from(statsAny);
          // Add the contingent name (from the key) to the data.
          contingentData['contingentName'] = contingentName;
          // Ensure essential fields exist.
          contingentData['matchesPlayed'] = contingentData['matchesPlayed'] ?? 0;
